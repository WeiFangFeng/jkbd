...
public class ExamActivity extends AppCompatActivity {
   // TextView tvTime, tvExamInfo, tv_ExamTitle, tv0p1,
  ...
  // Gallery mGallery;
    ...
    @BindView(R.id.tv_exam_title) TextView tv_ExamTitle;
    @BindView(R.id.im_exam) ImageView mImageView;
    ...
    @BindView(R.id.galley) Gallery mGallery;
